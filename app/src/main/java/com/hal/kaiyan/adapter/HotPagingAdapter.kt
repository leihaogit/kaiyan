...
import com.hal.kaiyan.databinding.CellVideoHotItemBinding
 ...
 * @author LeiHao
 * @date 2023/12/11
 * @description 热门界面的数据适配器
 */

class HotPagingAdapter :
    PagingDataAdapter<VideoInfoData, HotPagingAdapter.MyViewHolder>(diffCallback) {
    companion object {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val binding =
            CellVideoHotItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
